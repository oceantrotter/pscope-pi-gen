...
install -v -m 644 -d "${ROOTFS_DIR}/etc/hostapd/"
install -v -m 644 files/hostapd.conf "${ROOTFS_DIR}/etc/hostapd/hostapd.conf"
install -v -m 644 -d "${ROOTFS_DIR}/etc/default/"
...
install -v -m 644 -d "${ROOTFS_DIR}/etc/systemd/system/"
...
install -v -m 644 -d "${ROOTFS_DIR}/usr/bin/"
